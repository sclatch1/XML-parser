...
void eenCD::set_Title(string &title)
{
    Title = title;
}
...
void eenCD::set_Price(int price)
{
    Price = price;
}

string eenCD::get_Company()
{
    return Company;
}

void eenCD::set_Company(string company)
{
    Company = company;
}

string eenCD::get_Country()
{
    return Country;
}

void eenCD::set_Country(string coutry)
{
    Country = coutry;
}
